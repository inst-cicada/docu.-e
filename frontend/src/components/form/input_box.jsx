function InputBox({ label, name, value, onChange, aiGenerate = false }) {
    return (
        <div className="input_Box mx-auto max-w-sm rounded-xl p-7 outline outline-black/5 bg-white/30 backdrop-blur-3xl hover:shadow-lg hover:shadow-black/30 transition duration-300">
